...
### ❓ Ответы на вопросы. Сохранено по ссылке: https://docs.google.com/spreadsheets/d/1HcxdhAQtxoU6u5BMcAMTlrQHATo1o9oVZzQDiZrl71g/edit?usp=sharing 
 ...
 ### ❓ Ответы на вопросы. Сохранено по ссылке: https://disk.yandex.ru/i/rgBJJbTr4WaW6g 
    - Что такое ОР и ФР?
    - Что такое регрессионное тестирование?
    - В каких ситуациях применяется регрессионное тестирование?
    - В какой момент жизненного цикла задачи пишутся тест-кейсы и в чем их отличие от чек-листа?
    - Как выглядит идеальный баг-репорт?
    - Что происходит с точки зрения клиент-серверного взаимодействия, когда в браузере набираем “yandex.ru” и нажимаем “Ввод”?
    - Напиши тест-кейсы для онлайн-конвертера из даты в день недели, если конвертер принимает на вход строку в строгом формате ЦЦ.ЦЦ.ЦЦЦЦ, где Ц - цифра от 0 до 9.
